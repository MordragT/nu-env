...
export def "main replace" [path: string = ".", --extension(-e): string, --replace(-p): string, --with(-w): string = "", --recursive(-r)] {
    let extension = $extension | str trim --left --char '.'
...
export def "main replace-prefix" [path: string = ".", --extension(-e): string, --prefix(-p): string, --with(-w): string = "" --recursive(-r)] {
    let extension = $extension | str trim --left --char '.'
